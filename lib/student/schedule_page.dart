...
import '../shared/data/schedule_data.dart';
import '../shared/data/attendance_data.dart';
import '../shared/data/krs_data.dart';
import '../shared/widgets/custom_top_bar.dart';
import '../lecturer/widgets/attendance_modal.dart';
          ...
          child: SafeArea(
            ...
            child: Column(
              children: [
                ...
                // Day Tabs with white background and shadow - pill style like finance tabs
                Container(
          ...
          child: Container(
            ...
            child: TabBarView(
              ...
              children: [
                ...
                _buildScheduleList(_getScheduleForDay('Jumat')),
              ],
            ),
          ),
        ),
  ...
  Widget _buildInfoRow(IconData icon, String label, String value) {
    return Row(
      children: [
        ...
        SizedBox(
          width: 90, // Fixed width for label consistency
          child: Text(
            '$label:',
