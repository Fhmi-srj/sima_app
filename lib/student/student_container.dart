...
import '../lecturer/lecturer_schedule_page.dart';
import '../lecturer/attendance_management_page.dart';
import '../lecturer/lecturer_academic_page.dart';
import '../lecturer/lecturer_search_page.dart';
...
class StudentContainer extends StatefulWidget {
  ...
  const StudentContainer({super.key, required this.user});
